                        ...
                        <div class="container-xxl" id="kt_content_container">
                            ...
                            <%
                                ...
                                if (request.getParameter("courseId") != null) {
                                    ...
                                    if (request.getParameter("op").equals("update")) {
                                        courseId = String.valueOf(request.getParameter("courseId"));
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <form class="form" action="jp.do?action=process-course" method="POST" id="kt_modal_add_customer_form" data-kt-redirect="jp.do?action=course-list">
                                        <!--begin::Modal header-->
                                        ...
                                        <div class="modal-body py-10 px-lg-17">
                                            ...
                                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                                                <input type="hidden" class="form-control form-control-solid" placeholder="Course ID" name="courseId" value="<%=courseId%>"/>
                                                ...
                                                <div class="d-flex flex-column mb-7 fv-row">
                                                    ...
                                                    <select name="instructorId" aria-label="Select Instructor" data-control="select2" data-placeholder="Select Instructor..." data-dropdown-parent="#kt_modal_add_customer" class="form-select form-select-solid fw-bold">
                                                         <%
                                                            InstructorDAO instructorDAO = new InstructorDAO();
                                                            
                                                            LinkedHashMap instructorMap = null;
                                                            
                                                            instructorMap = instructorDAO.getInstructorMap();
                                                            if (instructorMap.isEmpty()) {
                                                                out.print("<option value=''>No data ...</option>");
                                                            } else {
                                                                out.print("<option value=''>Select Instructor...</option>");
                                                                Set keys = instructorMap.keySet();
                                                                Iterator itr = keys.iterator();
                                                                for (int i = 0; i < keys.size(); i++) {
                                                                    String id = itr.next().toString();
                                                                    String name = instructorMap.get(id).toString();
                                            ...
                                            %> 
                                                ...
                                                <div class="fv-row mb-7">
                                                    <!--begin::Label-->
                                                    <label class="required fs-6 fw-semibold mb-2">Course Name</label>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" class="form-control form-control-solid" placeholder="Course" name="courseName" value="<%=courseName%>"/>
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                                ...
                                                <div class="fv-row mb-7">
                                                    <!--begin::Label-->
                                                    <label class="required fs-6 fw-semibold mb-2">Unit(s)</label>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="number" class="form-control form-control-solid" placeholder="Unit" name="unit" value="<%=unit%>"/>
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
