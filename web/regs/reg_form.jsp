                            ...
                            <%
                                ...
                                if (request.getParameter("regId") != null) {
                                    ...
                                    if (request.getParameter("op").equals("update")) {
                                        regId = String.valueOf(request.getParameter("regId"));
                                        ...
                                        entryDate = rb.getDate();

                                        buttonName = "Update";
                                        buttonColour = "btn btn-primary";
                                    } else if (request.getParameter("op").equals("delete")) {

                                        courseId = String.valueOf(request.getParameter("regId"));
                                    ...
                                    <form class="form" action="jp.do?action=process-course" method="POST" id="kt_modal_add_customer_form" data-kt-redirect="jp.do?action=course-list">
                                        ...
                                        <div class="modal-body py-10 px-lg-17">
                                            ...
                                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                                                <input type="hidden" class="form-control form-control-solid" placeholder="Course ID" name="courseId" value="<%=regId%>"/>
                                            ...
                                            %> 
                                                ...
                                                <div class="fv-row mb-7">
                                                    <!--begin::Label-->
                                                    <label class="required fs-6 fw-semibold mb-2">Course ID</label>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
