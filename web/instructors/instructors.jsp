                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="card-px text-center py-20 my-10">
                                        ...
                                        <!--begin::Title-->
                                        <h2 class="fs-2x fw-bold mb-10">Welcome to Instructor App</h2>
                                        <!--end::Title-->
                                        <!--begin::Description-->
                                        <p class="text-gray-400 fs-4 fw-semibold mb-10">There are no Instructors added yet.
                                            <br />Kickstart your CRM by adding a your first Instructor</p>
                                        <!--end::Description-->
                                        <!--begin::Action-->
                                        <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Instructor</a>
                                        <!--end::Action-->
                                    </div>
                                    <!--end::Wrapper-->
                                    <!--begin::Illustration-->
