                                ...
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            ...
                                            <!--begin::Add customer-->
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Instructor</button>
                                            <!--end::Add customer-->
                                        </div>
                                        <!--end::Toolbar-->
                                        <!--begin::Group actions-->
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                        <thead>
                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-125px">Instructor ID</th>
                                        ...
                                        <tbody class="fw-semibold text-gray-600">
                                            ...
                                            <%
                                                ...
                                                for (InstructorBean ib : instructors) {

                                                    instructorId = ib.getInstructorId();
                                                    fullName = ib.getFullName();
                                                    email = ib.getEmail();
                                                    mobileNumber = ib.getMobileNumber();
                                                    date = ib.getDate();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="" class="text-gray-800 text-hover-primary mb-1"><%=instructorId%></a>
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="jp.do?action=instructor-form&op=update&instructorId=<%=instructorId%>" class="menu-link px-3">Update</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="jp.do?action=instructor-form&op=delete&instructorId=<%=instructorId%>" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Delete</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    </div>
                                                    <!--end::Menu-->
